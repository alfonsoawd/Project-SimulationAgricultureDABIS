...
out_file = here("sorties", "Simulation 1", "simulation_ctf_conv25.xlsx")
...
- Scénario contrefactuel : il reprend les aides payées en 2023, sauf l’aide de base qui est recalculée comme : (nombre de DPB activés en 2023) × (montant d’aide par hectare convergé 2025), montant simulé dans le script `01-preparation_donnees_ctf.R`.
